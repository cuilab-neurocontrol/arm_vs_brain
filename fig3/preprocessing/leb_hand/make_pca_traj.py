...
# -*- coding: utf-8 -*-
"""
PCA Trajectory Preprocessing for Fig3 - Leb Hand (Interception)
"""
...
def process_dataset(data_path, output_path, time_offset=-0.1):
...
# Main
nwb_base = os.path.join(SUBMISSION_ROOT, 'nwb_kilosort', 'leb', 'Data_recording')
output_base = os.path.join(SUBMISSION_ROOT, 'fig3', 'preprocessing', 'leb_hand')

# Get Interception datasets
datasets = [d for d in os.listdir(nwb_base) if 'Interception' in d]
